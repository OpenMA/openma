...
CXXTEST_TEST_REGISTRATION(PrecentileTest, vectorXdArg1)
CXXTEST_TEST_REGISTRATION(PrecentileTest, rowVectorXdArg1)
CXXTEST_TEST_REGISTRATION(PrecentileTest, vectorXdArg2)
CXXTEST_TEST_REGISTRATION(PrecentileTest, rowVectorXdArg2)
CXXTEST_TEST_REGISTRATION(PrecentileTest, vector10dArg3)
CXXTEST_TEST_REGISTRATION(PrecentileTest, vector10dArgX)
CXXTEST_TEST_REGISTRATION(PrecentileTest, rowVector10dArgX)