...
CXXTEST_SUITE(IIRFilterDesignTest)
{
  CXXTEST_TEST(butterLowOrder2Wn0Dot5)
  {
    Eigen::Matrix<double,Eigen::Dynamic,1> a,b;
    Eigen::butter(&b, &a, 2, 0.5);
  ...
  CXXTEST_TEST(butterLowOrder5Wn0Dot1)
  {
    Eigen::Matrix<double,Eigen::Dynamic,1> a,b;
    Eigen::butter(&b, &a, 5, 0.1);
  ...
  CXXTEST_TEST(butterHighOrder3Wn0Dot4)
  {
    Eigen::Matrix<double,Eigen::Dynamic,1> a,b;
    Eigen::butter(&b, &a, 3, 0.4, Eigen::HighPass);
  ...
  CXXTEST_TEST(butterPassOrder7Wn0Dot2To0Dot8)
  {
    Eigen::Matrix<double,Eigen::Dynamic,1> a,b;
    double wn[2] = {0.2, 0.8};
    Eigen::butter(&b, &a, 7, wn, Eigen::BandPass);
    ...
    TS_ASSERT_DELTA(b(7),  -3.1308821262182565e-15, 1e-14);
    ...
    TS_ASSERT_DELTA(a(8),  0.50855151093463624    , 1e-12); // Not so accurate?
  ...
  CXXTEST_TEST(butterStopOrder3Wn0Dot5To0Dot6)
  {
    Eigen::Matrix<double,Eigen::Dynamic,1> a,b;
    double wn[2] = {0.5, 0.6};
    Eigen::butter(&b, &a, 3, wn, Eigen::BandStop);
  ...
  CXXTEST_TEST(internalButtap2)
  {
    Eigen::Matrix< std::complex<double>, Eigen::Dynamic, 1> z, p;
    double k;
    Eigen::internal::buttap(&z, &p, &k,2);
  ...
  CXXTEST_TEST(internalButtap3)
  {
    Eigen::Matrix< std::complex<double>, Eigen::Dynamic, 1> z, p;
    double k;
    Eigen::internal::buttap(&z, &p, &k,3);
    TS_ASSERT_EQUALS(z.rows(), 0);
  ...
  CXXTEST_TEST(internalPoly)
  {
    Eigen::Matrix<double, Eigen::Dynamic, 1> a(3), b;
    a << -0.5, 0.0, 0.5;
    Eigen::internal::poly(&b,a);
    TS_ASSERT_EQUALS(b.rows(), 4);
  ...
  CXXTEST_TEST(internalZpk2tfIdentity)
  {
    ...
    Coeffs b_r = a_r;
    double k = 1.0;
    Eigen::internal::zpk2tf(&b, &a, z, p, k);
  ...
  CXXTEST_TEST(internalZpk2tfBis)
  {
  ...
  CXXTEST_TEST(internalNormalize)
  {
    ...
    Eigen::internal::normalize(&b_norm_in, &a_norm_in);
  ...
  CXXTEST_TEST(internalLp2lpDefault)
  {
    Eigen::Matrix< std::complex<double>, Eigen::Dynamic, 1> z, p, a, b;
    double k;
    Eigen::internal::buttap(&z, &p, &k, 3);
    Eigen::internal::zpk2tf(&b, &a, z, p, k);
    Eigen::internal::     lp2lp(&b, &a);
    TS_ASSERT_EQUALS(b.rows(), 1);
    TS_ASSERT_DELTA(b(0).real(), 1.0, 1e-15);
    TS_ASSERT_DELTA(b(0).real(), 1.0, 1e-15);
    TS_ASSERT_EQUALS(a.rows(), 4);
  ...
  CXXTEST_TEST(internalLp2lpHalf)
  {
    const double wo = 0.5;
    Eigen::Matrix< std::complex<double>, Eigen::Dynamic, 1> z, p, a, b;
    double k;
  ...
  CXXTEST_TEST(internalLp2hpThirth)
  {
    const double wo = 0.33;
    Eigen::Matrix< std::complex<double>, Eigen::Dynamic, 1> z, p, a, b;
    double k;
    Eigen::internal::buttap(&z, &p, &k, 4);
    Eigen::internal::zpk2tf(&b, &a, z, p, k);
    Eigen::internal::lp2hp(&b, &a, wo);
  ...
  CXXTEST_TEST(internalLp2bpDefault)
  {
    Eigen::Matrix< std::complex<double>, Eigen::Dynamic, 1> z, p, a, b;
    double k;
    Eigen::internal::buttap(&z, &p, &k, 5);
    Eigen::internal::zpk2tf(&b, &a, z, p, k);
    Eigen::internal::lp2bp(&b, &a);
    TS_ASSERT_EQUALS(b.rows(), 6);
    TS_ASSERT_DELTA(b(0).real(), 1.0, 1e-15);
    TS_ASSERT_DELTA(b(0).imag(), 0.0, 1e-15);
    TS_ASSERT_DELTA(b(1).real(), 0.0, 1e-15);
  ...
  CXXTEST_TEST(internalLp2bp)
  {
    Eigen::Matrix< std::complex<double>, Eigen::Dynamic, 1> z, p, a, b;
    double k;
    Eigen::internal::buttap(&z, &p, &k, 5);
    Eigen::internal::zpk2tf(&b, &a, z, p, k);
    Eigen::internal::lp2bp(&b, &a, 0.3, 0.8);
    TS_ASSERT_EQUALS(b.rows(), 6);
  ...
  CXXTEST_TEST(internalLp2bs)
  {
    Eigen::Matrix< std::complex<double>, Eigen::Dynamic, 1> z, p, a, b;
    double k;
    Eigen::internal::buttap(&z, &p, &k, 5);
    Eigen::internal::zpk2tf(&b, &a, z, p, k);
    Eigen::internal::lp2bs(&b, &a, 0.3, 0.8);
  ...
  CXXTEST_TEST(internalBilinear)
  {
    ...
    double k;
    Eigen::internal::buttap(&z, &p, &k, 3);
    Eigen::internal::zpk2tf(&b_, &a_, z, p, k);
    Eigen::internal::lp2lp(&b_, &a_, wo);
    Eigen::internal::bilinear(&b, &a, b_, a_, fs);
    TS_ASSERT_EQUALS(b.rows(), 4);
...
CXXTEST_SUITE_REGISTRATION(IIRFilterDesignTest)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, butterLowOrder2Wn0Dot5)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, butterLowOrder5Wn0Dot1)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, butterHighOrder3Wn0Dot4)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, butterPassOrder7Wn0Dot2To0Dot8)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, butterStopOrder3Wn0Dot5To0Dot6)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalButtap2)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalButtap3)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalPoly)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalZpk2tfIdentity)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalZpk2tfBis)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalNormalize)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalLp2lpDefault)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalLp2lpHalf)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalLp2hpThirth)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalLp2bpDefault)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalLp2bp)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalLp2bs)
CXXTEST_TEST_REGISTRATION(IIRFilterDesignTest, internalBilinear)