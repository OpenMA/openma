...
#include <Eigen_openma/Utils/gammaln.h>
...
CXXTEST_TEST_REGISTRATION(GammalnTest, zero)
CXXTEST_TEST_REGISTRATION(GammalnTest, positive)
CXXTEST_TEST_REGISTRATION(GammalnTest, floats)
CXXTEST_TEST_REGISTRATION(GammalnTest, integers)
CXXTEST_TEST_REGISTRATION(GammalnTest, doubleComplex)