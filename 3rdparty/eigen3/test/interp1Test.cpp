...
#include <Eigen_openma/Interpolation/Interp1.h>
...
CXXTEST_SUITE(Interp1Test)
{
  CXXTEST_TEST(linearXd)
  {
    ...
    Eigen::Interp1::linear(&yi, x, y, xi);
  ...
  CXXTEST_TEST(cubicXdInternalsSign)
  {
  ...
  CXXTEST_TEST(cubicXdInternalsSignBis)
  {
    Eigen::Matrix<double, Eigen::Dynamic, 1> x(10);
    x << 3.0, 6.0, -1.0, 44.12, 0.0, -0.27, -74.486, 0.0, 1.1, -110.0;
  ...
  CXXTEST_TEST(cubicXdInternalsCondition)
  {
    Eigen::Matrix<double, Eigen::Dynamic, 1> x(10);
    x << 3.0, 6.0, -1.0, 44.12, 0.0, -0.27, -74.486, 0.0, 1.1, -110.0;
...
CXXTEST_TEST_REGISTRATION(Interp1Test, cubicXdInternalsSign)
CXXTEST_TEST_REGISTRATION(Interp1Test, cubicXdInternalsSignBis)
CXXTEST_TEST_REGISTRATION(Interp1Test, cubicXdInternalsCondition)
CXXTEST_TEST_REGISTRATION(Interp1Test, cubicXdInternals)
CXXTEST_TEST_REGISTRATION(Interp1Test, cubicXd)
CXXTEST_TEST_REGISTRATION(Interp1Test, cubicXdBis)
