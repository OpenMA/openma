...
CXXTEST_SUITE(UnitQuaternionPoseEstimatorTest)
{
  ...
  CXXTEST_TEST(lowerlimbs)
  {
    ...
    TS_ASSERT_DELTA(L_Thigh_TCS->data()[438*10+0],   647.411523437500020, 1e-14);
    TS_ASSERT_DELTA(L_Thigh_TCS->data()[438*11+0],   637.549755859374950, 1e-14);
    // Sample #100
    ...
    TS_ASSERT_DELTA(L_Thigh_TCS->data()[438*10+100],  647.678857421875020, 1e-14);
    TS_ASSERT_DELTA(L_Thigh_TCS->data()[438*11+100],  675.265576171874950, 1e-14);
    // Sample #200
    ...
    TS_ASSERT_DELTA(L_Thigh_TCS->data()[438*10+200], 674.303796386718770, 1e-14);
