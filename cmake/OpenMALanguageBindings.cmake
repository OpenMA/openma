...
IF(BUILD_PYTHON_BINDINGS)
  ...
  MACRO(SWIG_GENERATE_PACKAGE_INIT_FILE _module _code _path)
    ADD_CUSTOM_COMMAND(TARGET ${SWIG_MODULE_${_module}_REAL_NAME} POST_BUILD
      COMMAND ${CMAKE_COMMAND} -D PROJECT_SOURCE_DIR:CHAR="${PROJECT_SOURCE_DIR}" -D PYTHON_PACKAGE_PATH:CHAR="${_path}" -D PYTHON_PACKAGE_INIT:CHAR="${_code}" -P "${PROJECT_SOURCE_DIR}/cmake/GeneratePythonPackageInitFile.cmake")
  ENDMACRO()
